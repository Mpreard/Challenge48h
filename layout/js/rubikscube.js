...
function ggwp(){
    window.open('https://etape1.tute/souviens?', '_blank');
   //Ho pardon j'ai encore des lacunes on dirait. On a besoin de magie ici.
}
	...
	for (var z=0;z<Rubik.SIZE;z++) {
		for (var y=0;y<Rubik.SIZE;y++) {
			for (var x=0;x<Rubik.SIZE;x++) {
				...
				console.log("Penser comme un cube. Ressentir comme un cube .Etre cube")
				// cube.complete();
